        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Loans"
              description="It is designed to streamline the process of managing loans within a financial institution (bank, credit union, or online lending platform). It automates various aspects of the loan lifecycle, from origination (application and approval) to servicing and repayment ."
              ghLink="https://github.com/Dhanapal0000/loans"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Dhanapal0000/https---github.com-Dhanapal0000-Smartagriculture"
